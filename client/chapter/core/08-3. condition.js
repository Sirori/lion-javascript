...
/* switch (thisTime) {
  ...
  case LUNCH:console.log('점심 시간에 복습을 한다.');break;

  case DINNER:console.log('저녁을 거르고 복습을 한다.');break;
...
if (thisTime == MORNING){
  ...
  console.log('점심 시간에 복습을 한다.');
} else if(thisTime == DINNER){
  console.log('저녁을 거르고 복습을 한다.');
} else if(thisTime == NIGHT){
  console.log('유튜브를 보지 않고 이듬 영상 강의 하나를 더 본다.');
