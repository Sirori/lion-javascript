...
// forEach를 사용하여 Event 걸어주기
//다만, 이벤트 처리할 때는 이벤트 위임(event delegation)이 더 좋음
...
//people 자료구조에서 나이만 모아놓은 배열 필요 => 나이를 -1로 가공처리하여 내보내고 싶음.
...
// split: 문자 -> 배열
const stringToArrary = str.split(' ');

console.log(stringToArrary);

// join: 배열-> 문자
const arrayToString = stringToArrary.join('/');
